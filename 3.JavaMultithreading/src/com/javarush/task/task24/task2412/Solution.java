...
public class Solution {
    ...
    public static void sort(List<Stock> list) {
        Collections.sort(list, new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                ...
                if (result == 0) {
                    result = -1 * ((Date) stock1.get("date")).compareTo((Date) stock2.get("date"));//if(((Date) stock1.get("date")).after((Date) stock2.get("date")))
                }
                if (result == 0) {
                    double change1;
    ...
    public static class Stock extends HashMap {
        public Stock(String name, String symbol, double open, double last) {
            ...
            put("open", open);
            put("last", last);
            put("date", new Date());//getRandomDate(2020));
        }
    ...
    public static List<Stock> getStocks() {
        ...
        stocks.add(new Stock("Fake Apple Inc.", "AAPL1", 125.64, 223.43));
